...
CLIENT_ID = json.loads(
    open(os.path.join(WORK_DIR, 'client_secrets.json'), 'r').read())['web']['client_id']
...
##Declare your postgre credentials
engine = create_engine(connect_string)

# Connect to Database and create database session
#engine = create_engine('postgresql:///categorywithusers.db')
...
def fbconnect():
    ...
    app_id = json.loads(open(os.path.join(WORK_DIR, 'fb_client_secrets.json'), 'r').read())[
        'web']['app_id']
    app_secret = json.loads(
        open(os.path.join(WORK_DIR, 'fb_client_secrets.json'), 'r').read())['web']['app_secret']
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets(os.path.join(WORK_DIR, 'client_secrets.json'), scope='')
